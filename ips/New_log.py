stub_input = {
    "conf": {"exchangeMinPrice": 2, "seedForPattern": 352, "cellModuleChargeRate": 10,
             ...
             "wearProbabilityB": 8, "gameTitle": "Test-Preflight", "tpsInertiaFriction": 0.5, "tick": 100},
    ...
    "weatherWind": {
        "done": [2.4663175124868384, 2.475413885309406, -0.2611678670598525], "current": 0},
    "weatherSun": {
        "done": [-0.41681411208332464, 0.02627884674634018, -0.12330687639221882], "current": 0},
    ...
    "objs": [{"path": [[]],  # Энергорайоны | [адрес энергорайона]
              ...
              "owner": {"place": 1, "player": 1},  # Владелец
              ...
              "charge": {"now": 0,  # Заряд накопителя
                         "then": [0, 0]},
              "id": ["main", 1],  # (тип, номер) для энергорайона
              "failed": False,  # Сломан из-за аварии
              "class": "main"}  # Тип
             ],
